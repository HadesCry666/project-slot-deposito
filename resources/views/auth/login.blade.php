...
@section('auth-content')
 <h1 class="display-font text-2xl font-bold text-white mb-1">Selamat Datang!</h1>
 <p class="text-slate-400 text-sm mb-7">Masuk untuk mengakses simulator interaktif.</p>
 ...
 <form action="{{ route('login.post') }}" method="POST" class="space-y-5">
  ...
  <div class="flex items-center gap-2">
   <input id="remember" name="remember" type="checkbox" class="w-4 h-4 rounded accent-emerald-500">
 ...
 <p class="text-center text-sm text-slate-500 mt-6">
  Belum punya akun?
  <a href="{{ route('register') }}" class="text-emerald-400 font-semibold hover:text-emerald-300 transition-colors">Daftar di sini</a>
 </p>
